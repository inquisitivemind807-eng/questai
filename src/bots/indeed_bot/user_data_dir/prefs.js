...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1775438377);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1775438377);
user_pref("app.update.lastUpdateTime.region-update-timer", 1775438377);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1775438377);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1775439797);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1775438377);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "standard");
user_pref("browser.download.viewableInternally.typeWasRegistered.avif", true);
user_pref("browser.download.viewableInternally.typeWasRegistered.webp", true);
user_pref("browser.migration.version", 150);
user_pref("browser.newtabpage.activity-stream.impressionId", "{3e14079c-fd3d-47b1-857b-44aba9cd5684}");
...
user_pref("browser.startup.lastColdStartupCheck", 1775439894);
...
user_pref("captchadetection.lastSubmission", 1772960);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECDmnuFivoOVjBAhAgV7RjBtf8w==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"9830ae57-27a9-4e1b-a69b-d946b864bea5\",\"pictureinpicture@mozilla.org\":\"a0082fb2-8611-48b0-9c73-c91fd4336eb9\",\"screenshots@mozilla.org\":\"d07375cf-f5f7-4a16-bd8a-47c7568ea113\",\"webcompat@mozilla.org\":\"c06dc867-0522-4529-93bc-41e1acb1930d\",\"firefox-compact-dark@mozilla.org\":\"ce8534ad-63d2-4ec8-8e5d-9d3f393555d7\",\"addons-search-detection@mozilla.com\":\"06013288-6d7c-4a29-accb-e46e794af772\"}");
...
user_pref("media.gmp-manager.buildID", "20250315105616");
user_pref("media.gmp-manager.lastCheck", 1775440246);
user_pref("media.gmp-manager.lastEmptyCheck", 1775440246);
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECEbh/gBRozPhBAjQPF5M2sZwDg==");
user_pref("toolkit.startup.last_success", 1775439892);
