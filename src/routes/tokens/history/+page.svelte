...
<main class="container mx-auto px-4 py-8">
    ...
    <div class="card-body">
      ...
      <div class="stats stats-vertical lg:stats-horizontal shadow w-full">
        ...
        <div class="stat">
          ...
          <div class="stat-value text-success">{$tokenStore.totalPurchased}</div>
        </div>
        <div class="stat">
  ...
  <!-- Filter -->
  <div class="mb-6">
    <select class="select select-bordered w-full max-w-xs" on:change={handleTypeChange} value={typeFilter}>
        ...
        <tbody>
          {#each transactions as tx}
            <tr>
              ...
              <td>
                <span class="font-semibold {tx.amount > 0 ? 'text-success' : 'text-error'}">
