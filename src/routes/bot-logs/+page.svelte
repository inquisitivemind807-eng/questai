...
<div class="container mx-auto p-6 max-w-4xl">
  <div class="flex items-center justify-between mb-6">
    ...
    <button class="btn btn-ghost btn-sm gap-1" on:click={() => goto('/choose-bot')}>
  ...
  {#if storeBots.length === 0}
    <div class="card bg-base-200 shadow-lg">
      <div class="card-body items-center text-center py-16">
        ...
        <p class="text-base-content/40 mt-1">Start a bot from the choose bot page to see logs here.</p>
        <button class="btn btn-primary btn-sm mt-4" on:click={() => goto('/choose-bot')}>
          Choose a Bot
        </button>
      </div>
    </div>
